        ...
        <div class="row py-4">
            <div class="col-lg-12 text-center">
                <p>
                    ...
                    মোহাম্মাদপুর, ঢাকা - হতে প্রকাশিত  
                    ফোন: ০১৮৮২৮৩৪০৭১  <br>
                    ই-মেইল : info@runbangla24.com
                </p>
            </div>
        </div>
    </div>
    <div class="container-fluid text-center" style="background: #a80f1b; color: #fff;"> 
        <small class="m-0 ">&copy; Developed By <a href="https://rusulazom.xyz">Rusul Azom Sumon</a>.   All Rights Reserved<a href="#">Runbangla24</a>. 
